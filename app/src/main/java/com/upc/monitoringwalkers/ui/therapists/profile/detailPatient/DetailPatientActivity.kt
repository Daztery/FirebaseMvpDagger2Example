...
import com.upc.monitoringwalkers.ui.therapists.profile.seePatientGraphics.SeeGraphicPatientActivity
...
class DetailPatientActivity : BaseActivity(), DetailPatientView {
    ...
    private fun initUi() {
        ...
        detail_patient_see_graphics.setOnClickListener {
            val intent = Intent(this, SeeGraphicPatientActivity::class.java)
            intent.putExtra("patientId", patientId)
            this.startActivity(intent)
        }
    }
